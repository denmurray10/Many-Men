Overview
Many Men is a responsive, single-page site that offers beginner-friendly information about men’s mental health, key warning signs, and practical ways to seek or offer support. It was developed as a Code Institute assessment project to demonstrate HTML, CSS, Bootstrap and basic JavaScript skills while also serving as a portfolio-ready, real-world style landing page.​

The core goals are to give men and their supporters a calm, organised place to start learning about mental health, and to showcase the developer’s ability to design and build a supportive, marketing-quality interface from a written brief.​
...
Implemented via a clear hero section with the title “Many Men – Men Matter”, explanatory subcopy and labelled navigation to each section.​
...
Implemented through a statistics section using simple metrics (e.g. 12.5%, 1 in 8, 75%) with concise explanations in plain language.​
...
Implemented by the “Signs he may be struggling” card section with headings, images and descriptive text for key signs such as changes in mood, withdrawal and physical changes.​
...
Implemented through sections outlining step-by-step actions: talking to someone, contacting a GP, using helplines and finding local support groups, including guidance for crisis situations.​
...
Implemented with “Quick Links”, “Nations” and “Legal” link groups that direct users to official Mental Health Foundation resources and related pages.​
...
Implemented with a “Get help” modal form (with validation and success message) and a newsletter sign-up form with confirmation feedback.​
...
“You don’t have to do this alone” / guidance content: Longer-form guidance explaining how to seek help, who to talk to and how to support others, written in approachable language.​
...
Planned assets for the README (to be added as images):

Desktop hero layout: Shows the main heading, supportive tagline and navigation above the fold.​

Mobile layout: Demonstrates the collapsed navbar and stacked content for smaller screens.​

Get help / newsletter modal: Highlights the form, validation messages and success alerts in context.​

Wireframe layouts: Basic layout wireframes for key breakpoints to document the initial structure before full styling.

Accessibility
Accessibility considerations applied include:

Use of semantic HTML elements (headings, sections, landmarks) to support screen readers and document structure.​

Colour choices aimed at maintaining sufficient contrast between text and background, especially for body copy and key CTAs.​

Clear, descriptive headings and link text so users can scan quickly and understand destinations.​
...
All main sections (hero, stats, signs, guidance, links, modals) render correctly at common screen sizes without horizontal scrolling.​
...
Validation
HTML: The HTML was run through the W3C HTML Validator and passed without critical errors; any minor warnings were reviewed and addressed where appropriate.​

CSS: The CSS was run through the W3C CSS Validator and passed, confirming there were no syntax errors in the stylesheet.​

Validation screenshots will be added to the README once captured.​

Test examples (feature-level)
Navbar: links, scroll behaviour and mobile toggle tested.​

Cards and hover states: verified that overlays and text remain readable.​

Modals: opened and closed multiple times, including via keyboard, to ensure no visual glitches.​

Forms: checked required fields, email patterns and minimum message length, along with success alert display and reset behaviour.​

Deployment
The site is deployed via GitHub Pages:

Code is stored in the main branch of the GitHub repository.​
...
Any updates are made locally, committed to Git, pushed to GitHub, and GitHub Pages automatically rebuilds and redeploys the latest version.​

Known Issues / Limitations
Layout quirks on very small screens: While the Bootstrap layout is responsive, minor spacing or stacking issues may appear on very narrow devices and will be refined in future iterations.​

Simulated form behaviour: The Get Help and newsletter forms currently simulate submission and show success messages on the front end; they do not send real emails or store data.​

Accessibility enhancements still in progress: Additional testing with screen readers, full keyboard-only navigation and ARIA labelling for modals is planned to further improve accessibility.​

Animations and transitions: Some scroll or hover transitions may feel slightly abrupt on lower-powered devices, and will be tuned to maintain a smooth, calm experience.​
...
Additional accessibility refinements, including ARIA attributes for interactive components and more detailed testing across assistive technologies.​

Potential expansion into multi-page content or interactive tools (e.g. simple check-in questions or task lists) if the project is extended beyond its initial assessment scope.​

Credits & Acknowledgements
Training & assessment: Code Institute – for the learning materials, project brief and assessment framework used to structure this skills test.​

Content research: Mental Health Foundation and similar reputable mental health organisations, used for researching themes, statistics and support pathways; all external resources are linked to their official websites rather than copied.​
...
Developer: Created by an aspiring full-stack developer with a background in marketing and design, using this project as a first fully self-coded, responsive site to bring men’s mental health support into focus.
